...
ab4_t   = np.loadtxt('AB4_002.out',usecols=(0,) )
ab4_u   = np.loadtxt('AB4_002.out',usecols=(1,) )

 
#am5_t   = np.loadtxt('AM5_002.out',usecols=(0,) )
#am5_u   = np.loadtxt('AM5_002.out',usecols=(1,) )

ab5_t   = np.loadtxt('AB5_002.out',usecols=(0,) )
ab5_u   = np.loadtxt('AB5_002.out',usecols=(1,) )
...
am4_t   = np.loadtxt('AM4_002.out',usecols=(0,) )
am4_u   = np.loadtxt('AM4_002.out',usecols=(1,) )

rk4_t   = np.loadtxt('RK4_002.out',usecols=(0,) )
rk4_u   = np.loadtxt('RK4_002.out',usecols=(1,) )
...
plt.plot(ab4_t,ab4_u,'-.g',linewidth=2,label=r'Adams Bashforth 4 step')
plt.plot(ab5_t,ab5_u,'-.g',linewidth=2,label=r'Adams Bashforth 5 step')
...
plt.legend()
plt.title (r'$\frac{dy}{dt} = -20y+20\sin(y)+\cos(t) $',fontsize=22)
