...
t_bwdE = np.loadtxt('../result/euler/bwdEuler_003.out',usecols=(0,) )
u_bwdE = np.loadtxt('../result/euler/bwdEuler_003.out',usecols=(1,) )

t_fwdE = np.loadtxt('../result/euler/fwdEuler_003.out',usecols=(0,) )
u_fwdE = np.loadtxt('../result/euler/fwdEuler_003.out',usecols=(1,) )

real_t= np.loadtxt('../realSol_003.out',usecols=(0,) )
real_y = np.loadtxt('../realSol_003.out',usecols=(1,) )
...
plt.legend()
plt.title (r'$\dot{y} = ty$',fontsize=22)
