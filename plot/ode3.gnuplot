...
plot \
	  'bwdEuler003.out' u 1:2 w l ls 4 t "BWD Euler" ,\
	  'fwdEuler003.out' u 1:2 w l ls 40 t "FWD Euler" ,\
        'AM3_003.out' u 1:2 w l ls 1  t "AM 3th (P-C)",\
        'AM2_003.out' u 1:2 w l ls 10  t "AM 2nd (P-C)",\
	  'realSol_003.out' u 1:2 w p ls 13 t "Soluzione Analitica" ,\
	  'AB2_003.out'     u 1:2 w l ls 7 t "AB 2th",\
	  'AB3_003.out'     u 1:2 w l ls 5 t "AB 3th",\
        'rk4_003.out'     u 1:2 w l ls 3 t "RK 4th"
