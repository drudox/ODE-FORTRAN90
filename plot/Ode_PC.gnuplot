...
plot \
	  'bwdEuler001.out' u 1:2 w l ls 4 t "bWD Euler" ,\
        'AM3_001.out' u 1:2 w l ls 10  t "AM 3th (P-C)",\
        'AM2_001.out' u 1:2 w l ls 1  t "AM 2nd (P-C)",\
	  'realSol_001.out' u 1:2 w p ls 13 t "Soluzione Analitica" ,\
	  'AB3_001.out'     u 1:2 w l ls 5 t "AB 3th",\
        'rk4_001.out'     u 1:2 w l ls 3 t "RK 4th"
