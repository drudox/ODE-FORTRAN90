...
t_bwdE = np.loadtxt('../result/euler/bwdEuler_001.out',usecols=(0,) )
u_bwdE = np.loadtxt('../result/euler/bwdEuler_001.out',usecols=(1,) )

t_fwdE = np.loadtxt('../result/euler/fwdEuler_001.out',usecols=(0,) )
u_fwdE = np.loadtxt('../result/euler/fwdEuler_001.out',usecols=(1,) )
