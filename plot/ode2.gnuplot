...
plot \
	  'fwdEuler002.out' u 1:2 w l ls 4 t "FWD Euler" ,\
	  'bwdEuler002.out' u 1:2 w l ls 40 t "BWD Euler" ,\
        'AB2_002.out' u 1:2 w l ls 1  t "AB 2nd",\
	  'realSol_002.out' u 1:2 w p ls 13 t "Soluzione Analitica" ,\
	  'AB3_002.out'     u 1:2 w l ls 5 t "AB 3th",\
