...
set title "Confronto metodi ODE " font "Helvetica, 20" 
...
set style line 10	dashtype 2 linecolor rgb "red"	  	lw 6 #ps 1.5
...
set style line 40	dashtype 2 linecolor rgb "black" 		lw 4 #ps 1.5
...
plot \
	  'bwdEuler002.out' u 1:2 w l ls 4 t "bWD Euler" ,\
        'AM3_002.out' u 1:2 w l ls 10  t "AM 3nd (P-C)",\
        'AM2_002.out' u 1:2 w l ls 1  t "AM 2nd (P-C)",\
	  'realSol_002.out' u 1:2 w p ls 13 t "Soluzione Analitica" ,\
	  'AB2_002.out'     u 1:2 w l ls 5 t "AB 2nd",\
        'rk4_002.out'     u 1:2 w l ls 3 t "RK 4th"
